...
DynamicJsonDocument es_doc(138);
...
String action1_schema[1] = {"{\"name\":\"body\",\"type\":\"string\"}"};

// Events
const char* event1_name = "evento";
String event1_subscriptionSchema[1] = {"{\"name\":\"subs\",\"value\":\"true\"}"};
...
void setup() {
    ...
    td = "{\"title\":\"asd\",\"id\":\"asdf\",\"@context\":[\"https://www.w3.org/2019/wot/td/v1\"],\"security\":\"nosec_sc\",\"securityDefinitions\":{\"nosec_sc\":{\"scheme\":\"nosec\"}},\"forms\":[{\"contentType\":\"application/json\",\"href\":\""+urlServer+"/all/properties\",\"op\":[\"readallproperties\",\"writeallproperties\"]},{\"contentType\":\"application/json\",\"href\":\""+urlSocket+"/all/properties\",\"op\":[\"readallproperties\",\"writeallproperties\"]}],\"properties\":{\"proprieta\":{\"forms\":[{\"contentType\":\"application/json\",\"href\":\""+urlServer+"/properties/"+property1_name+"\",\"op\":[\"readproperty\"]},{\"contentType\":\"application/json\",\"href\":\""+urlSocket+"/properties/"+property1_name+"\",\"op\":[\"readproperty\"]}],\"type\":\"boolean\",\"observable\":false,\"readOnly\":true,\"writeOnly\":true}},\"actions\":{\"azione\":{\"forms\":[{\"contentType\":\"application/json\",\"href\":\""+urlServer+"/actions/"+action1_name+"\",\"op\":\"invokeaction\"},{\"contentType\":\"application/json\",\"href\":\""+urlSocket+"/actions/"+action1_name+"\",\"op\":\"invokeaction\"}],\"input\":{\"body\":{\"type\":\"string\"}},\"output\":{\"type\":\"boolean\"},\"safe\":false,\"idempotent\":false}},\"events\":{\"evento\":{\"eventName\":\"evento\",\"forms\":[{\"contentType\":\"application/json\",\"href\":\""+urlSocket+"/events/"+event1_name+"\",\"op\":[\"subscribeevent\"]},{\"contentType\":\"application/json\",\"href\":\""+urlSocket+"/events/"+event1_name+"\",\"op\":[\"subscribeevent\"]}],\"actionsTriggered\":[],\"condition\":\"true\",\"subscription\":{\"subs\":{\"type\":\"boolean\",\"value\":\"true\"}},\"data\":{\"dat\":{\"type\":\"boolean\",\"value\":\"true\"}}}}}";
...
void loop() {
    int Push_button_state = digitalRead(14);
        ...
        if(resp_doc["body"].isNull())
            ...
            while(validInput and i<action1_inputsNumber) {
                switch(i) {
                    case 0: {
                        value = "";
                        serializeJson(resp_doc["body"], value);
            ...
            if(validInput) {
                ...
                bool output = azione(action1_input1_value);    
                resp = (String) output;
            }
            else
                resp = "InvalidInput";
...
// Action functions
bool azione(String body) {
	Serial.println("Azione triggered");
    Serial.println(body);
